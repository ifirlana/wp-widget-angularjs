...
config = 
	name : 'widget_wordpress_warehouse'
	version: '0.1.0'
...
gulp.task 'scripts', ->
	gulp.src(['src/main/app/coffee/service.coffee','src/main/app/coffee/controllers.coffee','src/main/app/coffee/application.coffee'])
		.pipe(coffeelint())
...
gulp.task 'dist', ['clean'], ->
	sequence ['lib', 'templates', 'scripts', 'html', 'stylehtml','css', 'images', 'data'], tar

gulp.task 'run', ['lib', 'templates', 'scripts', 'html', 'css', 'images', 'data'], ->
